            ...
            <div className="col-4 col-12-mobile">
              ...
              <Modal closeTimeoutMS={500} isOpen={modalIsOpen} onRequestClose={ () => setModalIsOpen(false)} style={{
                ...
                <aside className="description">
                  ...
                  <div class="close-container" onClick={ () => setModalIsOpen(false)} role="button">
              ...
              <Modal closeTimeoutMS={500} isOpen={modalIsOpen2} onRequestClose={ () => setModalIsOpen2(false)} style={{
                ...
                <aside className="description">
                  ...
                  <div class="close-container" onClick={ () => setModalIsOpen2(false)} role="button">
                        <div class="leftright"></div>
                        <div class="rightleft"></div>
                        <label class="close">close</label>
                    </div>
            ...
            <div className="col-4 col-12-mobile">
              ...
              <div>
                ...
                <aside className="description">
                  ...
                  <p>Stack : MERN.</p>
                  <button><a href="https://github.com/lalebdi/TheManhattanProject" target="_blank" rel="noreferrer" >Source Code</a></button>
                  </aside>
                  <img className="demo" src={gif6} alt="bug tracking app" />
                  </div>
                  <div class="close-container" onClick={ () => setModalIsOpen3(false)} role="button" >
                        <div class="leftright"></div>
                        <div class="rightleft"></div>
                        <label class="close">close</label>
                    </div>
              ...
              <div>
                ...
                <aside className="description">
                  ...
                  <br/>
                  <button className="live-btn" ><a href="https://5f529d2bfd13113312e00abd--friendly-borg-6726ab.netlify.app" target="_blank" rel="noreferrer" >Live Site </a></button>
                  </aside>
                  <img className="demo" src={gif5} alt="make awesome projects" />
                  </div>
                  <div class="close-container" onClick={ () => setModalIsOpen4(false)} role="button">
                        <div class="leftright"></div>
                        <div class="rightleft"></div>
                        <label class="close">close</label>
                    </div>
