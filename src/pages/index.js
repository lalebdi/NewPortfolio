            ...
            <div className="col-4 col-12-mobile">
              ...
              <Modal closeTimeoutMS={500} isOpen={modalIsOpen2} onRequestClose={ () => setModalIsOpen2(false)} style={{
                ...
                <aside className="description">
                  ...
                  <div class="close-container" onClick={ () => setModalIsOpen2(false)} role="button" tabindex="0">
                        <div class="leftright"></div>
                        <div class="rightleft"></div>
                        <label class="close">close</label>
                    </div>
            ...
            <div className="col-4 col-12-mobile">
              ...
              <div>
                ...
                <aside className="description">
                  ...
                  <p>Stack : MERN.</p>
                  <a href="https://github.com/lalebdi/TheManhattanProject" target="_blank" rel="noreferrer" ><button>Source Code</button></a>
                  </aside>
                  <img className="demo" src={gif6} alt="bug tracking app" />
                  </div>
                  <div class="close-container" onClick={ () => setModalIsOpen3(false)} role="button" tabindex="0" >
                        <div class="leftright"></div>
                        <div class="rightleft"></div>
                        <label class="close">close</label>
                    </div>
              ...
              <div>
                ...
                <aside className="description">
                  ...
                  <a href="https://github.com/lalebdi/chatApp" target="_blank" rel="noreferrer" ><button>Source Code</button></a>
                  <br/>
                  <a href="https://5f529d2bfd13113312e00abd--friendly-borg-6726ab.netlify.app" target="_blank" rel="noreferrer" ><button className="live-btn" >Live Site </button></a>
                  </aside>
                  <img className="demo" src={gif5} alt="make awesome projects" />
                  </div>
                  <div class="close-container" onClick={ () => setModalIsOpen4(false)}role="button" tabindex="0">
                        <div class="leftright"></div>
                        <div class="rightleft"></div>
                        <label class="close">close</label>
                    </div>
            ...
            <div className="col-4 col-12-mobile">
              ...
              <div>
                ...
                <aside className="description">
                  ...
                  <a href="https://github.com/lalebdi/AI" target="_blank" rel="noreferrer" ><button>Source Code</button></a>
                  <br/>
                  <a href="https://5f55304b080cf0e07c62f16a--sad-meninsky-ae278a.netlify.app/" target="_blank" rel="noreferrer" ><button className="live-btn" > Live Site </button></a>
                  </aside>
